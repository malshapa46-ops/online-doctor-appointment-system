...
$patients = [];
$res = $conn->query("SELECT user_id, username, full_name, email, contact_no, created_at FROM user WHERE role='patient' ORDER BY user_id DESC");
    ...
    <div class="container">
        ...
        <div class="page-header">
            ...
            <span style="font-size:0.9rem;color:#64748b;">
                <i class="fas fa-user" style="color:#2563eb;"></i> <?php echo count($patients); ?> patients registered
            </span>
        </div>
        ...
        <div class="table-card">
            <div class="table-title">
                ...
                <span class="count"><?php echo count($patients); ?></span>
            </div>
                        ...
                        <tbody>
                            <?php foreach ($patients as $p): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="mailto:<?php echo htmlspecialchars($p['email']); ?>" style="color:#2563eb;text-decoration:none;">
